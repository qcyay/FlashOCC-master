        ...
        if metric == 'ray-iou':
            ...
            for index, occ_pred in enumerate(tqdm(occ_results)):
                ...
                self.occ_eval_metrics.add_batch(
                    occ_pred['pred_occ'] if (isinstance(occ_pred, dict) and 'pred_occ' in occ_pred) else occ_pred,
                    # (Dx, Dy, Dz)
                ...
                if show_dir is not None:
                    ...
                    np.savez_compressed(save_path, pred=occ_pred['pred_occ'] if (
                                isinstance(occ_pred, dict) and 'pred_occ' in occ_pred) else occ_pred, gt=occ_gt,
